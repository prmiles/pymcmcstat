...
htmlhelp_basename = 'pymcmcstatdoc'
...
latex_documents = [
    (master_doc, 'pymcmcstat.tex', 'pymcmcstat Documentation',
     'Paul Miles', 'manual'),
]
...
man_pages = [
    (master_doc, 'pymcmcstat', 'pymcmcstat Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pymcmcstat', 'pymcmcstat Documentation',
     author, 'pymcmcstat', 'One line description of project.',
     'Miscellaneous'),
]
