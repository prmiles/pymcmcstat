...
class CreateSamplingMethods(unittest.TestCase):
    ...
    def test_create_sampling_methods(self):
        ...
        self.assertTrue(isinstance(SM.delayed_rejection, DelayedRejection), msg = 'Metropolis Class')
        self.assertTrue(isinstance(SM.adaptation, Adaptation), msg = 'Metropolis Class')
